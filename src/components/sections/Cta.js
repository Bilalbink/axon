...
const Cta = ({
  ...
  const shortenUrl = () => {
    ...
    if (customText === '' && originalUrl !== '') {
      ...
      axios.post('http://139.179.206.45:8080/api/short/', data)
        .then((res) => {
          console.log(res);
      ...
      axios.post('http://139.179.206.45:8080/api/customShort/', data)
        .then((res) => {
          console.log(res);
          setUrlFound(!urlFound);
          setInvalidCustom(false);
